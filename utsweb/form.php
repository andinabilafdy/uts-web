...
<body>
    ...
    <div class="artikel" data-aos="fade-up" data-aos-duration="1500">
        <form class="horizontal" id="dataa">
        ...
        <fieldset><legend>Personal Data</legend>
            <div class="grup">
                ...
                <input type="text" id="form_nama" required placeholder="Full Name">
            </div>
            <div class="grup">
                <label for="email">Email Address<span class="required">*</span></label>
                <input type="email" id="form_email" required placeholder="Email Address">
            </div>
            <div class="grup">
                <label for="no.telp">Phone<span class="required">*</span></label>
                <input type="tel" id="form_nohp" pattern="\d\d\d\d\d\d\d\d\d\d\d\d" required placeholder="Phone : 08**********">
            </div>
            <div class="grup-select">
                <label for="na">Nationality<span class="required">*</span><br></label>
                <select class="select" id="form_na">
           ...
           <div class="grup-checkbox">
                <label for="layanan">Required Service<span class="required">*</span><br></label>
                <div>
                    <input class="checkbox" type="checkbox" id="ps" value="Postal Service">
                    <label class="check" for="PostalService">Postal Service</label>
                </div>
                <div>
                    <input class="checkbox" type="checkbox" id="pps" value="Parcel Post Service">
                    <label class="check" for="ParcelPostService">Parcel Post Service</label>
                </div>
                <div> 
                    <input class="checkbox" type="checkbox" id="fs" value="Financial Service">
                    <label class="check" for="FinancialService">Financial Service</label>
                </div>
            </div> 
            <div class="grup-offsett">
                <center><button type="submit" id="submit" value="Sign In">Submit</button></center>  
                <br><center><button type="reset" value="Reset">Reset</button></center></br>
            </div>
            </fieldset>
...
<script src="folderjs/form.js"></script>
</html>