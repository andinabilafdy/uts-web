...
<body>
    ...
    <header>
        <div class="container">
            ...
            <ul>
                ...
                <li class="active"><a href="kariradmin.php">Career</a></li>
    ...
    <section class="bidangusaha">
        <br>
        <center><h2>Karir</h2></center>
        </br>
        <br>
        <center> <img src="img/posdigital.jpg" style="width:30%;height:30%;" align="bottom"></center>
        </br>
        <br>
        <center> <img src="img/posdigital2.jpg" style="width:30%;height:30%;" align="bottom"></center>
        </br>
        <br>
        <center> <img src="img/posdigital3.jpg" style="width:30%;height:30%;" align="bottom"></center>
        </br>
    </section>
