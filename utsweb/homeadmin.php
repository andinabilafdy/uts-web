...
<body>
    ...
    <header>
        <div class="container">
            ...
            <ul>
                <li class="active"><a href="homeadmin.php">Home & List Product</a></li>
                <li><a href="rekapadmin.php">Calculation</a></li>
    ...
    <section class="banner">
        <h2>Welcome to Halo Pos for Admin!</h2>
    </section>
    <div class="home">
        <section class="info">
            <div class="web">
                
            <section class="bidangusaha">
        <center><h3>Produk Kami</h3></center>
        <center> <img src="img/bidangusaha.jpg" style="width:30%;height:30%;" align="bottom"></center>
        <center><h4>Transformasi Bisnis</h4></center>
        <center> <img src="img/transformasibisnis.jpg" style="width:30%;height:30%;" align="bottom"></center>
    </section>
